    ...
    <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-[#FFFFFF] dark:bg-[#0A0A0A] text-[#111827] dark:text-[#FAFAFA] font-sans transition-colors duration-300 space-y-6">
      ...
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 py-6 space-y-6">
        ...
        {/* ==================================================
            ...
            ================================================== */}
        <div className="no-print bg-[#FFFFFF] dark:bg-[#181818] p-4 sm:px-6 sm:py-4 rounded-[16px] border border-[#D1D5DB] dark:border-[#3F3F46] shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all duration-150">
          <div className="flex items-center space-x-3.5 min-w-0">
            <div className="w-10 h-10 rounded-[10px] bg-[#111827] dark:bg-[#FAFAFA] text-[#FFFFFF] dark:text-[#111111] flex items-center justify-center shrink-0 shadow-xs">
              <FileText size={20} className="stroke-[2.2]" />
            </div>
            <div className="min-w-0">
              <h1 className="text-2xl font-bold tracking-tight text-[#111827] dark:text-[#FAFAFA] leading-tight truncate">
                AI Resume Builder
              </h1>
              <p className="text-[14px] text-[#6B7280] dark:text-[#A3A3A3] mt-0.5 truncate">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="h-[44px] px-4 rounded-[12px] border border-[#D1D5DB] dark:border-[#3F3F46] bg-[#FFFFFF] dark:bg-[#181818] text-[#111827] dark:text-[#FAFAFA] hover:bg-[#F9FAFB] dark:hover:bg-[#232323] transition-all duration-150 text-[14px] font-medium flex items-center space-x-2 cursor-pointer"
            >
            ...
            <button
              ...
              className="h-[44px] px-5 rounded-[12px] bg-[#111827] hover:bg-[#000000] dark:bg-[#FAFAFA] dark:hover:bg-[#E5E7EB] text-[#FFFFFF] dark:text-[#111111] font-medium text-[14px] shadow-xs transition-all duration-150 flex items-center space-x-2 cursor-pointer"
            >
              <Printer size={16} />
...
<<<<<<< HEAD
        {/* ==================================================
            DASHBOARD OVERVIEW CARDS (Fixed 104px Height)
            ================================================== */}
        <div className="no-print grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="h-[104px] min-h-[104px] p-4 rounded-[16px] bg-[#FFFFFF] dark:bg-[#181818] border border-[#D1D5DB] dark:border-[#3F3F46] shadow-xs flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <span className="text-[12px] font-semibold text-[#6B7280] dark:text-[#A3A3A3] uppercase tracking-wider">Total Resumes</span>
              <div className="w-8 h-8 rounded-[10px] bg-[#F8FAFC] dark:bg-[#111111] border border-[#E5E7EB] dark:border-[#2A2A2A] flex items-center justify-center shrink-0">
                <FileText size={20} className="text-[#111827] dark:text-[#FAFAFA]" />
              </div>
            </div>
            <div className="text-2xl font-bold text-[#111827] dark:text-[#FAFAFA] font-heading tracking-tight leading-none mt-auto">1</div>
          </div>

          <div className="h-[104px] min-h-[104px] p-4 rounded-[16px] bg-[#FFFFFF] dark:bg-[#181818] border border-[#D1D5DB] dark:border-[#3F3F46] shadow-xs flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <span className="text-[12px] font-semibold text-[#6B7280] dark:text-[#A3A3A3] uppercase tracking-wider">ATS Score</span>
              <div className="w-8 h-8 rounded-[10px] bg-[#F8FAFC] dark:bg-[#111111] border border-[#E5E7EB] dark:border-[#2A2A2A] flex items-center justify-center shrink-0">
                <BarChart3 size={20} className="text-[#111827] dark:text-[#FAFAFA]" />
              </div>
            </div>
            <div className="text-2xl font-bold text-[#111827] dark:text-[#FAFAFA] font-heading tracking-tight leading-none mt-auto">
          ...
          <div className="h-[104px] min-h-[104px] p-4 rounded-[16px] bg-[#FFFFFF] dark:bg-[#181818] border border-[#D1D5DB] dark:border-[#3F3F46] shadow-xs flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <span className="text-[12px] font-semibold text-[#6B7280] dark:text-[#A3A3A3] uppercase tracking-wider">Active Template</span>
              <div className="w-8 h-8 rounded-[10px] bg-[#F8FAFC] dark:bg-[#111111] border border-[#E5E7EB] dark:border-[#2A2A2A] flex items-center justify-center shrink-0">
                <Layers size={20} className="text-[#111827] dark:text-[#FAFAFA]" />
              </div>
            </div>
            <div className="text-2xl font-bold text-[#111827] dark:text-[#FAFAFA] font-heading tracking-tight leading-none capitalize mt-auto">
              {resumeData.template}
            </div>
          </div>
          ...
          <div className="h-[104px] min-h-[104px] p-4 rounded-[16px] bg-[#FFFFFF] dark:bg-[#181818] border border-[#D1D5DB] dark:border-[#3F3F46] shadow-xs flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <span className="text-[12px] font-semibold text-[#6B7280] dark:text-[#A3A3A3] uppercase tracking-wider">Downloads</span>
              <div className="w-8 h-8 rounded-[10px] bg-[#F8FAFC] dark:bg-[#111111] border border-[#E5E7EB] dark:border-[#2A2A2A] flex items-center justify-center shrink-0">
...
=======
        ...
        <div className="no-print grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          <div className="p-3.5 sm:p-5 lg:p-6 rounded-[16px] bg-[#FFFFFF] dark:bg-[#18181B] border border-[#E5E7EB] dark:border-[#2A2A2A] shadow-xs flex items-center justify-between min-w-0">
            <div className="min-w-0 flex-1 space-y-0.5 sm:space-y-1">
              <p className="text-[12px] sm:text-[14px] font-normal text-[#6B7280] dark:text-[#A1A1AA] truncate">Total Resumes</p>
              <p className="text-[15px] sm:text-[22px] lg:text-[28px] font-semibold text-[#111827] dark:text-[#FAFAFA] leading-tight truncate">1 Draft</p>
              <p className="text-[11px] sm:text-[12px] font-normal text-[#6B7280] dark:text-[#A1A1AA] truncate">Active profile</p>
            </div>
          ...
          <div className="p-3.5 sm:p-5 lg:p-6 rounded-[16px] bg-[#FFFFFF] dark:bg-[#18181B] border border-[#E5E7EB] dark:border-[#2A2A2A] shadow-xs flex items-center justify-between min-w-0">
            <div className="min-w-0 flex-1 space-y-0.5 sm:space-y-1">
              <p className="text-[12px] sm:text-[14px] font-normal text-[#6B7280] dark:text-[#A1A1AA] truncate">ATS Compatibility</p>
              <p className="text-[15px] sm:text-[22px] lg:text-[28px] font-semibold text-[#111827] dark:text-[#FAFAFA] leading-tight truncate">
                {atsResult ? `${atsResult.overall_score}%` : '88%'}
              </p>
              <p className="text-[11px] sm:text-[12px] font-normal text-[#6B7280] dark:text-[#A1A1AA] truncate">Industry rating</p>
            </div>
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-[8px] sm:rounded-[10px] bg-[#F8FAFC] dark:bg-[#111111] border border-[#E5E7EB] dark:border-[#2A2A2A] text-[#111827] dark:text-[#FAFAFA] flex items-center justify-center shrink-0 ml-1.5 sm:ml-3">
          ...
          <div className="p-3.5 sm:p-5 lg:p-6 rounded-[16px] bg-[#FFFFFF] dark:bg-[#18181B] border border-[#E5E7EB] dark:border-[#2A2A2A] shadow-xs flex items-center justify-between min-w-0">
            <div className="min-w-0 flex-1 space-y-0.5 sm:space-y-1">
              <p className="text-[12px] sm:text-[14px] font-normal text-[#6B7280] dark:text-[#A1A1AA] truncate">Active Template</p>
              <p className="text-[15px] sm:text-[22px] lg:text-[28px] font-semibold text-[#111827] dark:text-[#FAFAFA] leading-tight truncate capitalize">
                {resumeData.template}
              </p>
              <p className="text-[11px] sm:text-[12px] font-normal text-[#6B7280] dark:text-[#A1A1AA] truncate">Single-page layout</p>
            </div>
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-[8px] sm:rounded-[10px] bg-[#F8FAFC] dark:bg-[#111111] border border-[#E5E7EB] dark:border-[#2A2A2A] text-[#111827] dark:text-[#FAFAFA] flex items-center justify-center shrink-0 ml-1.5 sm:ml-3">
          ...
          <div className="p-3.5 sm:p-5 lg:p-6 rounded-[16px] bg-[#FFFFFF] dark:bg-[#18181B] border border-[#E5E7EB] dark:border-[#2A2A2A] shadow-xs flex items-center justify-between min-w-0">
            <div className="min-w-0 flex-1 space-y-0.5 sm:space-y-1">
              <p className="text-[12px] sm:text-[14px] font-normal text-[#6B7280] dark:text-[#A1A1AA] truncate">AI Enhancements</p>
              ...
              <p className="text-[11px] sm:text-[12px] font-normal text-[#6B7280] dark:text-[#A1A1AA] truncate">Action verbs engine</p>
            </div>
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-[8px] sm:rounded-[10px] bg-[#F8FAFC] dark:bg-[#111111] border border-[#E5E7EB] dark:border-[#2A2A2A] text-[#111827] dark:text-[#FAFAFA] flex items-center justify-center shrink-0 ml-1.5 sm:ml-3">
              <Sparkles className="w-4 h-4 sm:w-5 sm:h-5" />
>>>>>>> f2c446875dd632df28e1f6e68f679957205099f4
            </div>
            <div className="text-2xl font-bold text-[#111827] dark:text-[#FAFAFA] font-heading tracking-tight leading-none mt-auto">12</div>
          </div>
        </div>

        {/* ==================================================
            MAIN NAVIGATION TABS BAR (Exact 48px Height)
            ================================================== */}
        <div className="no-print bg-[#FFFFFF] dark:bg-[#181818] px-2 h-[48px] rounded-[12px] border border-[#D1D5DB] dark:border-[#3F3F46] shadow-xs flex items-center gap-2 overflow-x-auto">
          {[
            ...
            return (
              <button
                ...
                className={`h-[36px] px-3.5 rounded-[10px] text-[14px] font-medium transition-all duration-150 flex items-center space-x-2 whitespace-nowrap cursor-pointer ${
                  isActive
                    ? 'bg-[#111827] dark:bg-[#FAFAFA] text-[#FFFFFF] dark:text-[#111111]'
                    : 'bg-transparent text-[#6B7280] dark:text-[#A3A3A3] hover:bg-[#F9FAFB] dark:hover:bg-[#232323] hover:text-[#111827] dark:hover:text-[#FAFAFA]'
                }`}
              >
        ...
        {/* ==================================================
            TAB 1: RESUME FORM EDITOR (300px Left Sidebar + Remaining Content)
            ================================================== */}
        {activeTab === 'editor' && (
          <div className="no-print flex flex-col lg:flex-row gap-6 items-start">
            {/* Step Navigation Sidebar (300px fixed width, 48px item heights) */}
            <div className="w-full lg:w-[300px] shrink-0 bg-[#FFFFFF] dark:bg-[#181818] rounded-[16px] border border-[#D1D5DB] dark:border-[#3F3F46] p-3 space-y-1 shadow-xs">
              <div className="text-[12px] font-semibold uppercase tracking-wider text-[#6B7280] dark:text-[#A3A3A3] px-3 py-2 mb-1 border-b border-[#E5E7EB] dark:border-[#2A2A2A]">
                Resume Sections
              </div>
              {steps.map((st, idx) => {
                const Icon = st.icon;
                ...
                return (
                  <button
                    ...
                    className={`w-full h-[48px] flex items-center justify-between px-3.5 rounded-[10px] text-[14px] font-medium transition-all duration-150 cursor-pointer ${
                      isActive
                        ? 'bg-[#111827] dark:bg-[#FAFAFA] text-[#FFFFFF] dark:text-[#111111]'
                        : 'text-[#4B5563] dark:text-[#A3A3A3] hover:bg-[#F9FAFB] dark:hover:bg-[#232323] hover:text-[#111827] dark:hover:text-[#FAFAFA]'
                    }`}
                  >
            ...
            {/* Form Fields Area (Remaining width, 24px section padding, 48px inputs, 16px gaps) */}
            <div className="flex-1 min-w-0 bg-[#FFFFFF] dark:bg-[#181818] rounded-[16px] border border-[#D1D5DB] dark:border-[#3F3F46] p-6 space-y-6 shadow-xs">
              ...
              {editorStep === 0 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                    <div>
                      <label className="text-[14px] font-medium text-[#111827] dark:text-[#FAFAFA] block mb-1.5">Full Name</label>
                      <input
                        type="text"
                        value={resumeData.personalInfo.fullName}
                        onChange={(e) => updatePersonalInfo('fullName', e.target.value)}
                        className="w-full h-[48px] px-4 bg-[#FFFFFF] dark:bg-[#181818] border border-[#D1D5DB] dark:border-[#3F3F46] rounded-[12px] text-[14px] text-[#111827] dark:text-[#FAFAFA] focus:outline-none focus:border-[#111827] dark:focus:border-[#FAFAFA]"
                      />
                    </div>
                    <div>
                      <label className="text-[14px] font-medium text-[#111827] dark:text-[#FAFAFA] block mb-1.5">Email Address</label>
                      <input
                        type="email"
                    ...
                    <div>
                      <label className="text-[14px] font-medium text-[#111827] dark:text-[#FAFAFA] block mb-1.5">Phone Number</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-[14px] font-medium text-[#111827] dark:text-[#FAFAFA] block mb-1.5">Location</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-[14px] font-medium text-[#111827] dark:text-[#FAFAFA] block mb-1.5">LinkedIn Profile</label>
                      <input
                        type="url"
                    ...
                    <div>
                      <label className="text-[14px] font-medium text-[#111827] dark:text-[#FAFAFA] block mb-1.5">GitHub Profile</label>
                      <input
                        type="url"
        ...
        {(activeTab === 'preview' || activeTab === 'editor') && (
          <div className={`${activeTab === 'editor' ? 'no-print border-t pt-8 border-[#E5E7EB] dark:border-[#2A2A2A]' : ''} space-y-4`}>
            ...
            <div className="no-print bg-[#FFFFFF] dark:bg-[#181818] p-4 rounded-[12px] border border-[#E5E7EB] dark:border-[#2A2A2A] flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-xs">
              <div>
                <h3 className="text-[18px] font-bold text-[#111827] dark:text-[#FAFAFA]">Resume Paper View</h3>
                <p className="text-[14px] text-[#6B7280] dark:text-[#A3A3A3] whitespace-nowrap">High-resolution print & PDF preview</p>
              </div>
              <button
                onClick={handlePrintPDF}
                className="h-9 px-4 rounded-[10px] bg-[#111827] hover:bg-[#000000] dark:bg-[#FAFAFA] dark:hover:bg-[#E5E7EB] text-[#FFFFFF] dark:text-[#111111] text-[14px] font-medium flex items-center justify-center gap-2 whitespace-nowrap shrink-0 cursor-pointer transition-colors sm:w-auto w-full"
              >
