...
export default function QuizGeneratorPage() {
  ...
  return (
    <div className="w-full h-full overflow-y-auto bg-[#FFFFFF] dark:bg-[#0A0A0A] text-[#111827] dark:text-[#FAFAFA] transition-colors">
          ...
          <AnimatePresence mode="wait">
            ...
            {viewState === 'config' && (
              ...
              >
                ...
                <div className="lg:col-span-5 bg-[#FFFFFF] dark:bg-[#181818] p-6 rounded-[12px] border border-[#E5E7EB] dark:border-[#2A2A2A] shadow-sm flex flex-col justify-between sticky top-24 self-start space-y-8">
                      ...
                      <div className="grid grid-cols-4 gap-3">
                        {[5, 10, 15, 20].map((count) => (
                          <button
                            ...
                            className={`h-12 rounded-[8px] text-[14px] font-medium transition cursor-pointer ${
                              numQuestions === count
                                ? 'bg-[#111827] dark:bg-[#FAFAFA] text-[#FFFFFF] dark:text-[#111111]'
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {[
                          ...
                          <button
                            ...
                            className={`h-12 px-3 rounded-[8px] text-[12px] font-medium transition text-left cursor-pointer ${
                              quizType === t.id
                                ? 'bg-[#111827] dark:bg-[#FAFAFA] text-[#FFFFFF] dark:text-[#111111]'
                                : 'bg-[#FFFFFF] dark:bg-[#181818] border border-[#D1D5DB] dark:border-[#2A2A2A] text-[#111827] dark:text-[#FAFAFA] hover:bg-[#F9FAFB] dark:hover:bg-[#232323]'
                            }`}
                      ...
                      <div className="grid grid-cols-4 gap-3">
                        {[
                          ...
                          <button
                            ...
                            className={`h-12 rounded-[8px] text-[12px] font-medium transition cursor-pointer ${
                              timerOption === tm.secs
                                ? 'bg-[#111827] dark:bg-[#FAFAFA] text-[#FFFFFF] dark:text-[#111111]'
                                : 'bg-[#FFFFFF] dark:bg-[#181818] border border-[#D1D5DB] dark:border-[#2A2A2A] text-[#111827] dark:text-[#FAFAFA] hover:bg-[#F9FAFB] dark:hover:bg-[#232323]'
                            }`}
                  ...
                  <button
                    ...
                    className="w-full h-14 rounded-[10px] bg-[#111827] hover:bg-[#000000] dark:bg-[#FAFAFA] dark:hover:bg-[#E5E7EB] text-[#FFFFFF] dark:text-[#111111] font-medium text-[16px] shadow-sm transition flex items-center justify-center gap-2 cursor-pointer disabled:opacity-40 mt-4"
                  >
                    {generating ? (
                      <>
