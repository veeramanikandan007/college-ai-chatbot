...
export default function ChatMessage({
  ...
  return (
    ...
    >
      ...
      <div
        className={`group relative max-w-[88%] sm:max-w-[80%] rounded-2xl p-4 text-sm leading-relaxed shadow-2xs transition-colors duration-300 ${
          isUser
            ? 'bg-[#0A2A6A] dark:bg-slate-800 text-white rounded-tr-xs'
            : 'bg-white dark:bg-slate-900 text-[#1F2937] dark:text-slate-200 border border-[#E2E8F0] dark:border-slate-700 rounded-tl-xs'
        }`}
      >
        {/* Thinking Indicator */}
        {message.isThinking && (
