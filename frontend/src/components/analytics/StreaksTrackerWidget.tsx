    ...
    <div className="bg-[#FFFFFF] dark:bg-[#181818] p-6 rounded-[12px] border border-[#D1D5DB] dark:border-[#3F3F46] shadow-xs space-y-4">
      <div className="flex items-center justify-between pb-4 border-b border-[#F3F4F6] dark:border-[#2A2A2A]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-[18px] font-bold text-[#111827] dark:text-[#FAFAFA]">Activity Streaks</h2>
      ...
      {!loading && streaks && (
        <div className="p-4 rounded-[10px] bg-[#F8FAFC] dark:bg-[#111111] border border-[#E5E7EB] dark:border-[#2A2A2A] text-center text-[14px] font-medium text-[#111827] dark:text-[#FAFAFA]">
